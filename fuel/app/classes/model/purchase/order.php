...
class Model_Purchase_Order extends Model_Soft
{
	...
	protected static $_table_name = 'purchase_order';
	...
	protected static $_has_many = array(
		'items' => array(
			'key_from' => 'id',
			'model_to' => 'Model_Purchase_Order_Item',
			'key_to' => 'order_id',
			'cascade_save' => true,
			'cascade_delete' => true,
		),
	...
	{
		$bill_item = Model_Purchase_Order_Item::find('first', array('where' => array('order_id' => $booking->bill->id)));
