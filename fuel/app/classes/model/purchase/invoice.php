...
class Model_Purchase_Invoice extends Model_Soft
{
	...
	public static function validate($factory)
	{
		...
		$val->add_field('supplier_id', 'Customer', 'required');
		$val->add_field('supplier_name', 'Customer Name', 'required|max_length[140]');
	...
	protected static $_table_name = 'purchase_invoice';
	...
	protected static $_has_many = array(
		'items' => array(
			'key_from' => 'id',
			'model_to' => 'Model_Purchase_Invoice_Item',
			'key_to' => 'invoice_id',
			'cascade_save' => true,
			'cascade_delete' => true,
		),
		'payments' => array(
			'key_from' => 'id',
			'model_to' => 'Model_Purchase_Payment',
			'key_to' => 'invoice_id',
			'cascade_save' => true,
			'cascade_delete' => true,
		),
