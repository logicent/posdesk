...
class Model_Purchases_Order extends Model_Soft
{
	...
	protected static $_table_name = 'purchases_order';

	protected static $_has_one = array(
		'invoice' => array(
			'key_from' => 'id',
			'model_to' => 'Model_Purchases_Invoice',
			'key_to' => 'source_id',
			'cascade_save' => false,
	...
	protected static $_has_many = array(
		'items' => array(
			'key_from' => 'id',
			'model_to' => 'Model_Purchases_Order_Item',
			'key_to' => 'order_id',
			'cascade_save' => true,
			'cascade_delete' => true,
		),
	...
	{
		$bill_item = Model_Purchases_Order_Item::find('first', array('where' => array('order_id' => $booking->bill->id)));
	...
	public static function applyDiscountAmount(&$purchases_order)
	{
		$purchases_order->amount_due -= $purchases_order->disc_total;
		$purchases_order->balance_due = $purchases_order->amount_due - $purchases_order->amount_paid;

		if ($purchases_order->balance_due == 0)
			$purchases_order->paid_status = self::ORDER_PAID_STATUS_FULL_PAID;
	}
