...
class Controller_Admin_Settings_Email_Settings extends Controller_Authenticate
{
	...
	public function action_index()
	{
		...
		$this->template->content = View::forge('settings/email/settings/index', $data);
	}
	...
	public function action_view($id = null)
	{
		...
		$this->template->content = View::forge('settings/email/settings/view', $data);
	...
	public function action_create()
	{
		if (Input::method() == 'POST')
		{
			...
			if ($val->run())
			{
				...
				if ($email_setting and $email_setting->save())
				{
					...
					Response::redirect('admin/settings/email/settings');
				}
		...
		$this->template->title = "Email Settings";
		$this->template->content = View::forge('settings/email/settings/create');
	...
	public function action_edit($id = null)
	{
		...
		$this->template->title = "Email settings";
		$this->template->content = View::forge('settings/email/settings/edit');
