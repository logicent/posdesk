<?php
class Controller_Admin_Settings_Payment_Method extends Controller_Authenticate
{
	...
	public function action_index()
	{
		...
		$this->template->content = View::forge('settings/payment_method/index', $data);

	}

	public function action_view($id = null)
	{
		is_null($id) and Response::redirect('admin/settings/payment/method');

		if ( ! $data['payment_method'] = Model_Accounts_Payment_Method::find($id))
		{
			Session::set_flash('error', 'Could not find payment method #'.$id);
			Response::redirect('admin/settings/payment/method');
		}

		$this->template->title = "Payment Methods";
		$this->template->content = View::forge('settings/payment_method/view', $data);
	...
	public function action_create()
	{
		...
		$this->template->title = "Payment Methods";
		$this->template->content = View::forge('settings/payment_method/create');
	...
	public function action_edit($id = null)
	{
		...
		$this->template->title = "Payment Methods";
		$this->template->content = View::forge('settings/payment_method/edit');
