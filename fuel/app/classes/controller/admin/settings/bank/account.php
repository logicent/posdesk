...
class Controller_Admin_Settings_Bank_Account extends Controller_Authenticate
{
	public function action_index()
	{
		$data['bank_accounts'] = Model_Accounts_Bank_Account::find('all');
		$this->template->title = "Bank Accounts";
		$this->template->content = View::forge('settings/bank_account/index', $data);
	}

	public function action_view($id = null)
	{
		is_null($id) and Response::redirect('admin/settings/bank/account');

		if ( ! $data['bank_account'] = Model_Accounts_Bank_Account::find($id))
		{
			Session::set_flash('error', 'Could not find bank account #'.$id);
			Response::redirect('admin/settings/bank/account');
		}
		$this->template->title = "Bank Accounts";
		$this->template->content = View::forge('settings/bank_account/view', $data);
	}
	...
	public function action_create()
	{
		...
		$this->template->title = "Bank Accounts";
		$this->template->content = View::forge('settings/bank_account/create');
	}
	...
	public function action_edit($id = null)
	{
		...
		$this->template->title = "Bank Accounts";
		$this->template->content = View::forge('settings/bank_account/edit');
	}
