<h2 class="page-header">Viewing <span class='text-muted'>Purchase</span>&nbsp;
...
<?= Form::open(array("class"=>"form-horizontal", "autocomplete" => "off")); ?>
	<div class="form-group">
        <div class="col-md-6">
            ...
            <?= Form::label($purchase_invoice->source, 'source', array('class' => 'col-md-4 form-control')); ?>
        </div>
        <div class="col-md-3">
			<?= Form::label('Invoice no.', 'invoice_num', array('class'=>'control-label')); ?>
            <?= Form::label($purchase_invoice->invoice_num, 'invoice_num', array('class' => 'col-md-4 form-control')); ?>
		</div>
		<div class="col-md-3">
			<?= Form::label('Status', 'status', array('class'=>'control-label')); ?>
            <?= Form::label(Model_Purchases_Invoice::$invoice_status[$purchase_invoice->status], 'status', array('class' => 'col-md-4 form-control')); ?>
		</div>
	</div>
	<div class="form-group">
        <div class="col-md-6">
            <?= Form::label('Source ref.', 'source_id', array('class'=>'control-label')); ?>
            <?= Form::label(Model_Lease::listOptions()[$purchase_invoice->source_id], 'source_id', 
                            array('class' => 'col-md-4 form-control')); ?>
        </div>
		<div class="col-md-3">
			<?= Form::label('Issue date', 'issue_date', array('class'=>'control-label')); ?>
            <?= Form::label($purchase_invoice->issue_date, 'issue_date', array('class' => 'col-md-4 form-control')); ?>
		</div>
		<div class="col-md-3">
			<?= Form::label('Due date', 'due_date', array('class'=>'control-label')); ?>
            <?= Form::label($purchase_invoice->due_date, 'due_date', array('class' => 'col-md-4 form-control')); ?>
		</div>
	</div>
	<div class="form-group">
    <div class="col-md-6">
			<?= Form::label('Tenant', 'customer_name', array('class'=>'control-label')); ?>
            <?= Form::label($purchase_invoice->customer_name, 'customer_name', array('class' => 'col-md-4 form-control')); ?>
        </div>
        <div class="col-md-6">
			<?= Form::label('Billing address', 'billing_address', array('class'=>'control-label')); ?>
            <?= Form::label($purchase_invoice->billing_address, 'billing_address', array('class' => 'col-md-4 form-control')); ?>
        </div>
        <div class="col-md-6">
        </div>
    </div>
	...
	<div id="doc_tabs" class="tab-content">
		<div id="bills" class="tab-pane fade">
			<?= render('purchases/invoice/item/index', array('purchase_invoice_items' => $purchase_invoice->items)); ?>
		</div>
		<div id="receipts" class="tab-pane fade">
			<table class="table table-hover">
				...
				<tbody>
        <?php 
            if (!empty($purchase_invoice->receipts)) :
    ...
    <div class="form-group">
        <div class="col-md-6">
            ...
            <?= Form::textarea('notes', Input::post('notes', $purchase_invoice->notes), 
        ...
        <div class="col-md-3">
            ...
            <?= Form::label(number_format($purchase_invoice->advance_paid, 2), '', array('class' => 'col-md-4 form-control text-number')); ?>
            <?php Form::label('Discount Amount', 'disc_total', array('class'=>'control-label')); ?>
            <?php Form::label($purchase_invoice->disc_total, '', array('class' => 'col-md-4 form-control text-number')); ?>
        </div>
        <div class="col-md-3">
            <?= Form::label('Amount Due', 'amount_due', array('class'=>'control-label')); ?>
            <?= Form::label(number_format($purchase_invoice->amount_due, 2), '', array('class' => 'col-md-4 form-control text-number')); ?>
        </div>
        <div class="col-md-3">
            <?= Form::label('Amount Paid', 'amount_paid', array('class'=>'control-label')); ?>
            <?= Form::label(number_format($purchase_invoice->amount_paid, 2), '', array('class' => 'col-md-4 form-control text-number')); ?>
        </div>
        <div class="col-md-3">
            <?= Form::label('Balance Due', 'balance_due', array('class'=>'control-label')); ?>
            <?= Form::label(number_format($purchase_invoice->balance_due, 2), '', array('class' => 'col-md-4 form-control text-number text-red')); ?>
        </div>        
    </div>
    <div class="form-group">
        <div class="col-md-6">
            <?= Form::label('Summary', 'summary', array('class'=>'control-label')); ?>
            <?= Form::label($purchase_invoice->summary, 'summary', array('class' => 'col-md-4 form-control')); ?>
        </div>
        <div class="col-md-6">
            <?= Form::label('Paid Status', 'paid_status', array('class'=>'control-label')); ?>
            <?= Form::label(Model_Purchases_Invoice::$invoice_paid_status[$purchase_invoice->paid_status], 'paid_status', array('class' => 'col-md-4 form-control')); ?>
        </div>
    </div>
    <?php Form::label($purchase_invoice->tax_total, 'tax_total', array('class' => 'col-md-4 form-control')); ?>
    <hr>
	<div class="form-group">
		<div class="col-md-6">
